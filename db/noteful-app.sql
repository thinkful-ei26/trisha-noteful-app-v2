...
-- Doesn't Work -- https://chartio.com/resources/tutorials/how-to-define-an-auto-increment-primary-key-in-postgresql/
-- CREATE SEQUENCE newID
--   start 1000
--   increment 1;

-- Error: psql:/Users/trisha/projects/sql/noteful-app.sql:69: ERROR:  column "newid" does not exist
-- LINE 5:     nextval(newID),

-- ALTER SEQUENCE serial RESTART WITH 1000;
-- http://www.postgresqltutorial.com/postgresql-serial/
-- must update serial to table_name_id_seq
-- ALTER SEQUENCE might need to be done before CREATE TABLE and INSERT INTO

ALTER SEQUENCE notes_id_seq RESTART WITH 1000;

-- You could also SELECT serval('notest_id)seq', 999);
-- SELECT currval(pg_get_serial_sequence('notes', 'id'));
